...
class GalleryAdvance extends React.Component {
    render() {
        return (
            <Aux>
                <Row>
                                ...
                                <div className="grid">
                                    <figure className="effect-julia">
                                        ...
                                        <figcaption>
                                            ...
                                            <a href={DEMO.BLANK_LINK} onClick={DEMO.BLANK_CALL}>View more</a>
                                        </figcaption>
                                    </figure>
                                    <figure className="effect-julia">
                                ...
                                <div className="grid">
                                    <figure className="effect-goliath">
                                        ...
                                        <figcaption>
                                            ...
                                            <a href={DEMO.BLANK_LINK}>View more</a>
                                        </figcaption>
                                    </figure>
                                    <figure className="effect-goliath">
                                ...
                                <div className="grid">
                                    <figure className="effect-hera">
                                        ...
                                        <figcaption>
                                            ...
                                            <p>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-file-pdf-o f-36"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-file-image-o f-36"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-file-archive-o f-36"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-file-code-o f-36"/></a>
                                            </p>
                                        </figcaption>
                                    </figure>
                                    <figure className="effect-hera">
                                ...
                                <div className="grid">
                                    <figure className="effect-winston">
                                        ...
                                        <figcaption>
                                            ...
                                            <p>
                                                <a href={DEMO.BLANK_LINK} className='text-white'><i className="fa fa-star fa-3x"/></a>
                                                <a href={DEMO.BLANK_LINK} className='text-white'><i className="fa fa-comments fa-3x"/></a>
                                                <a href={DEMO.BLANK_LINK} className='text-white'><i className="fa fa-envelope-open fa-3x"/></a>
                                            </p>
                                        </figcaption>
                                    </figure>
                                    <figure className="effect-winston">
                                ...
                                <div className="grid">
                                    <figure className="effect-terry">
                                        ...
                                        <figcaption>
                                            ...
                                            <p>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-download"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-heart"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-share"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-tags"/></a>
                                            </p>
                                        </figcaption>
                                    </figure>
                                    <figure className="effect-terry">
                                ...
                                <div className="grid">
                                    <figure className="effect-phoebe">
                                        ...
                                        <figcaption>
                                            ...
                                            <p className='m-4'>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-user fa-3x"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-heart fa-3x"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-cog fa-3x"/></a>
                                            </p>
                                        </figcaption>
                                    </figure>
                                    <figure className="effect-phoebe">
                                ...
                                <div className="grid">
                                    <figure className="effect-kira">
                                        ...
                                        <figcaption>
                                            ...
                                            <p>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-home"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-download"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-heart"/></a>
                                                <a href={DEMO.BLANK_LINK}><i className="fa fa-fw fa-share"/></a>
                                            </p>
