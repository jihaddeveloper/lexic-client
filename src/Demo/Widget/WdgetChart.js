...
import AmChartCommand from "./Chart/AmChartCommand";
...
import FlotChartLast3Days from "./Chart/FlotChartLast3Days";
...
import FlotChartTransactions from "./Chart/FlotChartTransactions";
import FlotChartTransactions1 from "./Chart/FlotChartTransactions1";
import FlotChartTransactions2 from "./Chart/FlotChartTransactions2";
import FlotChartTransactions3 from "./Chart/FlotChartTransactions3";
import AmChartStats from "./Chart/AmChartStats";
import AmChartStatistics11 from "./Chart/AmChartStatistics11";
import FlotChartUserCard from "./Chart/FlotChartUserCard";
                ...
                <Row>
                    <Col xl={4}>
                        <Card className='card-command'>
                            <Card.Header>
                                <Card.Title as='h5'><i className="card-icon fa fa-comment f-16 m-r-5"/>Command</Card.Title>
                            </Card.Header>
                        ...
                        <Card className='theme-bg gradientcolor'>
                            ...
                            <Card.Body className='p-0'>
                                <div className="p-2 text-center">
                                    <a href={DEMO.BLANK_LINK} className="text-white text-uppercase f-w-400">Month</a>
                                    <a href={DEMO.BLANK_LINK} className="btn btn-round bg-white text-uppercase mx-3 px-4 f-w-400">Week</a>
                                    <a href={DEMO.BLANK_LINK} className="text-white text-uppercase f-w-400">Day</a>
                                </div>
                                <div className="my-3 text-center text-white">
                                    <a href={DEMO.BLANK_LINK} className=" d-block mb-1">$78.89 <span className="feather icon-arrow-up"/></a>
                    ...
                    <Col xl={8}>
                        <Card>
                            <Card.Header>
                                <Card.Title as='h5'>Last 3 Days</Card.Title>
                            </Card.Header>
                            <Card.Body>
                                <div className="row">
                                    <div className="col-md-4 col-6 text-center m-b-15">
                                        <h3 className="f-w-300">$32,42</h3>
                                        <span className="text-right">Mon <strong>+5,93</strong></span>
                                    </div>

                                    <div className="col-md-4 col-6 text-center m-b-15">
                                        <h3 className="f-w-300">$28,36</h3>
                                        <span className="text-right">Tue <strong>-4,24</strong></span>
                                    </div>

                                    <div className="col-md-4 col-12 text-center m-b-15">
                                        <h3 className="f-w-300">$59,48</h3>
                                        <span className="text-right">Wed <strong>+12,25</strong></span>
                                    </div>
                                </div>
                            </Card.Body>
                            <Card.Body className='p-0'>
                            ...
                            <Card.Body>
                                <div className="row align-items-center justify-content-center">
                                    ...
                                    <div className="col-auto">
                                        <FlotChartTransactions height='80px'/>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                    ...
                    <Col xl={4} md={6}>
                        <Card>
                            ...
                            <Card.Body>
                                <div className="row align-items-center justify-content-center">
                                    <div className="col-6">
                                        <FlotChartTransactions1/>
                                        <h3 className="f-w-300 pt-3 mb-0">$80,48</h3>
                                    </div>
                                    <div className="col-6">
                                        <FlotChartTransactions2/>
                    ...
                    <Col xl={4} md={12}>
                        <Card>
                            ...
                            <Card.Body>
                                <div className="row align-items-center justify-content-center">
                                    <div className="col-6">
                                        <FlotChartTransactions3 height='80px'/>
                                    </div>
                                    <div className="col-6">
                    ...
                    <Col xl={4} md={12}>
                        <Card>
                            <Card.Body className='user-chart'>
                                <div className="row align-items-center justify-content-center">
                                    <div className="col-auto">
                                        <i className="fa fa-line-chart f-30"/>
                                    </div>
                                    <div className="col text-center">
                                        <img className="img-fluid rounded-circle" src={avatar1} alt="dashboard-user"/>
                                    </div>
                                    <div className="col-auto">
                                        <i className="fa fa-envelope f-30"/>
                                    </div>
                                </div>
                                ...
                                <div className="row m-t-40">
                                    ...
                                    <div className="col-auto">
                                        <h3 className="f-w-300"><i className="fa fa-caret-up text-c-green f-22 m-r-10 m-l-10"/>13 %</h3>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
