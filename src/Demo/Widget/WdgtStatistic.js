...
import {Row, Col, Card, Carousel, Tab, Nav} from 'react-bootstrap';
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <div className="row m-t-30">
                                    ...
                                    <div className="col-6">
                                        <a href={DEMO.BLANK_LINK} className="btn text-uppercase border btn-block btn-outline-secondary">message</a>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                        ...
                        <Card className='profit-bar'>
                            <Card.Body>
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <i className="fa fa-money f-20 text-white float-right"/>
                                    </div>
                                </div>
                        ...
                        <Card className='theme-bg2 assets-value'>
                            <Card.Body className='p-0'>
                                ...
                                <div className="card-block text-center">
                                    <i className="fa fa-line-chart text-white f-30 m-b-20"/>
                    ...
                    <Col md={6} xl={4}>
                        <Card className='theme-bg'>
                            <Card.Header className='borderless'>
                                <Card.Title as='h5' className='text-white'>Timer</Card.Title>
                            </Card.Header>
                            <Card.Body className='text-center'>
                                <h2 className="f-w-300 m-b-30 text-white">00:24:38</h2>
                                <i className="feather icon-play f-50 text-white d-block m-b-25"/>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} xl={4}>
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="row align-items-center justify-content-center">
                                    ...
                                    <div className="col-6">
                                        <a href={DEMO.BLANK_LINK} className="btn btn-primary shadow-2 text-uppercase btn-block">Pay now</a>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                            ...
                            <Card.Body>
                                ...
                                <div className="row align-items-center justify-content-center">
                                    ...
                                    <div className="col-6 text-right">
                                        <i className="fa fa-pie-chart f-30 text-c-green"/>
                                    </div>
                                </div>
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="row align-items-center justify-content-center">
                                    ...
                                    <div className="col text-right">
                                        <i className="fa fa-pie-chart f-30 text-c-purple"/>
                                    </div>
                                </div>
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="row align-items-center justify-content-center">
                                    ...
                                    <div className="col text-right">
                                        <i className="fa fa-line-chart f-30 text-c-purple"/>
                                    </div>
                                </div>
                                <div className="leads-progress mt-3">
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="row m-t-25">
                                    <div className="col-6">
                                        <a href={DEMO.BLANK_LINK} className="btn btn-primary  text-uppercase btn-block">Deposit</a>
                                    </div>
                                    <div className="col-6 p-l-0">
                                        <a href={DEMO.BLANK_LINK} className="btn text-uppercase border btn-block btn-outline-secondary">withdraw</a>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="review-emotion mb-3">
                                    <div className="row align-items-center justify-content-center">
                                        <div className="col">
                                            <span><i className="fa fa-smile-o text-c-green f-20"/></span>
                                        </div>
                                        <div className="col-auto">
                                ...
                                <div className="review-emotion mb-3">
                                    <div className="row align-items-center justify-content-center">
                                        <div className="col">
                                            <span><i className="fa fa-smile-o text-c-purple f-20"/></span>
                                        </div>
                                        <div className="col-auto">
                                ...
                                <div className="review-emotion mb-0">
                                    <div className="row align-items-center justify-content-center">
                                        <div className="col">
                                            <span><i className="fa fa-smile-o text-c-red f-20"/></span>
                                        </div>
                                        <div className="col-auto">
                    ...
                    <Col md={6} xl={4}>
                        <Card className='theme-bg Invoice-bar'>
                            <Card.Body>
                                ...
                                <div className="row">
                                    <div className="col-auto">
                                        <i className="fa fa-file-text f-30 text-white"/>
                                    </div>
                                    <div className="col">
                    ...
                    <Col md={6} xl={4}>
                        <Card className='theme-bg2 ticket-customer'>
                            <Card.Body>
                                ...
                                <i className="fa fa-file-text text-white f-70"/>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} xl={4}>
                            ...
                            <Card.Body>
                                <Carousel>
                                    <Carousel.Item>
                                        <div className="row">
                                            <div className="col-auto">
                                                <img className="rounded-circle" style={{width: '85px'}} src={avatar2} alt="activity-user"/>
                                            </div>
                                            <div className="col">
                                    ...
                                    <Carousel.Item>
                                        <div className="row">
                                            <div className="col-auto">
                                                <img className="rounded-circle" style={{width: '85px'}} src={avatar1} alt="activity-user"/>
                                            </div>
                                            <div className="col">
                                                <h5 className="mb-3">Jarvis Pepperspray</h5>
                                                <span className="f-w-300 text-muted mb-3 d-block">Separated they live in Bookmarksgrove..</span>
                                    ...
                                    <Carousel.Item>
                                        <div className="row">
                                            <div className="col-auto">
                                                <img className="rounded-circle" style={{width: '85px'}} src={avatar3} alt="activity-user"/>
                                            </div>
                                            <div className="col">
                                                <h5 className="mb-3">Jarvis Pepperspray</h5>
                                                <span className="f-w-300 text-muted mb-3 d-block">Separated they live in Bookmarksgrove..</span>
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                ...
                                <a href={DEMO.BLANK_LINK} className="btn btn-primary shadow-2 text-uppercase btn-block" style={{maxWidth: '150px', margin: '0 auto'}}>add funds</a>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} xl={4}>
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            ...
                            <Card.Body className='sale-view'>
                                ...
                                <div className="row align-items-center justify-content-center">
                                    <div className="col">
                                        <ReactFlot id='sale-view' options={optionsSaleView} data={dataSaleView} width="100px" height="80px" />
                                    </div>
                                    <div className="col-auto text-right">
                                        <i className="fa fa-dollar f-30 text-white theme-bg"/>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            ...
                            <Card.Body className='sale-view'>
                                ...
                                <div className="row align-items-center justify-content-center">
                                    <div className="col">
                                        <ReactFlot id='sale-view-second' options={optionsSaleViewSecond} data={dataSaleViewSecond} width="100px" height="80px" />
                                    </div>
                                    <div className="col-auto text-right">
                                        <i className="fa fa-bitcoin f-30 text-white theme-bg"/>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            ...
                            <Card.Body className='sale-view'>
                                ...
                                <div className="row align-items-center justify-content-center">
                                    <div className="col">
                                        <ReactFlot id='sale-view-third' options={optionsSaleViewThird} data={dataSaleViewThird} width="100px" height="80px" />
                                    </div>
                                    <div className="col-auto text-right">
                    ...
                    <Col md={6} xl={4}>
                        <Card className='theme-bg bitcoin-wallet'>
                            <Card.Body>
                                ...
                                <i className="fa fa-btc f-70 text-white"/>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} xl={4}>
                        <Card className='theme-bg2 bitcoin-wallet'>
                            <Card.Body>
                                ...
                                <span className="text-white d-block">Ratings by Market Capitalization</span>
                                <i className="fa fa-dollar f-70 text-white"/>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} xl={4}>
                        <Card className='bg-c-blue bitcoin-wallet'>
                            <Card.Body>
                                ...
                                <span className="text-white d-block">Ratings by Market Capitalization</span>
                                <i className="fa fa-gbp f-70 text-white"/>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                ...
                                <a href={DEMO.BLANK_LINK} className="btn btn-primary shadow-2 text-uppercase btn-block" style={{maxWidth: '150px', margin: '0 auto'}}>add friend</a>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} xl={4}>
                                ...
                                <div className="media">
                                    ...
                                    <div className="media-body">
                                        <span className='float-right'>
                                            <ReactFlot id='app-sale' options={optionsAppSale} data={dataAppSale} width="100px" height="40px" />
                                        </span>
                                    </div>
                                </div>
                                <div className="media mt-4">
                                    ...
                                    <div className="media-body">
                                        <span className='float-right'>
                                            <ReactFlot id='app-sale-1' options={optionsAppSale1} data={dataAppSale1} width="100px" height="40px" />
                                        </span>
                                    </div>
                                </div>
                                <div className="media mt-4">
                                    ...
                                    <div className="media-body">
                                        <span className='float-right'>
                                            <ReactFlot id='app-sale-2' options={optionsAppSale2} data={dataAppSale2} width="100px" height="40px" />
                                        </span>
                                    </div>
                                </div>
                                <div className="media mt-4">
                                    ...
                                    <div className="media-body">
                                        <span className='float-right'>
                                            <ReactFlot id='app-sale-3' options={optionsAppSale} data={dataAppSale} width="100px" height="40px" />
                                        </span>
                                    </div>
                                </div>
                            </Card.Body>
                            ...
                            <Card.Body>
                                <div className="row">
                                    <div className="col-6">
                                        <h5>2,456</h5>
                                        <h6>Total Sales</h6>
                                        <ReactFlot id='user-sale' options={optionsUserSale} data={dataUserSale} width="100px" height="50px" />
                                        <h6 className="mt-2 mb-0">2567<span className="m-r-10 m-l-10">Today</span></h6>
                                    </div>
                                    <div className="col-6">
                                        <h5>4,679</h5>
                                        <h6>Total User</h6>
                                        <ReactFlot id='user-sale1' options={optionsUserSale1} data={dataUserSale1} width="100px" height="50px" />
                                        <h6 className="mt-2 mb-0">7896<span className="m-r-10 m-l-10">Today</span></h6>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                            ...
                            <Card.Body>
                                <div className="row">
                                    <div className="col-6">
                                        <h5>1,456</h5>
                                        <h6>Total Revenue</h6>
                                        <ReactFlot id='user-sale2' options={optionsUserSale2} data={dataUserSale2} width="100px" height="50px" />
                                        <h6 className="mt-2 mb-0">7423<span className="m-r-10 m-l-10">Yesterday</span></h6>
                                    </div>
                                    <div className="col-6">
                                        <h5>5,652</h5>
                                        <h6>Total User</h6>
                                        <ReactFlot id='user-sale3' options={optionsUserSale3} data={dataUserSale3} width="100px" height="50px" />
                                        <h6 className="mt-2 mb-0">9632<span className="m-r-10 m-l-10">Today</span></h6>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                            ...
                            <Card.Body>
                                <div className="row">
                                    <div className="col-6">
                                        <h5>4,456</h5>
                                        <h6>Total Order</h6>
                                        <ReactFlot id='user-sale4' options={optionsUserSale4} data={dataUserSale4} width="100px" height="50px" />
                                        <h6 className="mt-2 mb-0">4532<span className="m-r-10 m-l-10">Today</span></h6>
                                    </div>
                                    <div className="col-6">
                                        <h5>6,325</h5>
                                        <h6>Total User</h6>
                                        <ReactFlot id='user-sale5' options={optionsUserSale5} data={dataUserSale5} width="100px" height="50px" />
                                        <h6 className="mt-2 mb-0">4532<span className="m-r-10 m-l-10">Tomorrow</span></h6>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
