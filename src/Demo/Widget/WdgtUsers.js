...
class WdgtUsers extends React.Component {
    render() {
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            ...
                            <Card.Body className='post-emoticon'>
                                ...
                                <ul>
                                    <li className="m-r-25"><i className="fa fa-smile-o f-26 text-c-green m-r-10"/>235</li>
                                    <li className="m-r-25"><i className="fa fa-smile-o f-26 text-c-purple m-r-10"/>95</li>
                                    <li className="m-r-0"><i className="fa fa-smile-o f-26 text-c-red m-r-10"/>18</li>
                                </ul>
                            </Card.Body>
                        </Card>
                    </Col>
                        ...
                        <Card className='user-designer'>
                            <Card.Body className='text-center'>
                                ...
                                <div className="designer m-t-30">
                                    <a href={DEMO.BLANK_LINK} className="btn btn-primary shadow-2 text-uppercase btn-block">add friend</a>
                                </div>
                            </Card.Body>
                        </Card>
                    </Col>
                            ...
                            <Card.Body className='p-0'>
                                ...
                                <div className="project-main">
                                    <div className="row text-center">
                                        ...
                                        <div className="col-md-4 col-12">
                                            <h6 className="text-muted m-0"><i className="fa fa-file-text m-r-5"/> 28 Task</h6>
                                        </div>
                                    </div>
                                </div>
                            </Card.Body>
