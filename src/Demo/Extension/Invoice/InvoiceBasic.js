                        ...
                        <div>
                            <div className="card" ref={el => (this.componentRef = el)}>
                                        ...
                                        <div className="invoice-box row">
                                            <div className="col-sm-12">
                                                <table className="table table-responsive invoice-table table-borderless">
                                                    <tbody>
                                                    <tr>
                                                        <td><img src={darkLogo} className="m-b-10" alt=""/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Company name </td>
                                                    </tr>
                                ...
                                <div className="card-block">
                                    <div className="row invoive-info">
                                        ...
                                        <div className="col-md-4 col-sm-6">
                                            <h6 className="m-b-20">Invoice Number <span>#123685479624</span></h6>
                            ...
                            <div className="row text-center">
                                <div className="col-sm-12 invoice-btn-group text-center">
                                    ...
                                    />
                                    <button type="button" className="btn btn-secondary m-b-10 ">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
